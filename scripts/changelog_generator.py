...
class ChangelogGenerator:
    ...
    def get_git_commits(self, from_ref: str = None, to_ref: str = "HEAD") -> List[CommitInfo]:
    ...
    def generate_changelog_section(self, version: str, date: str, commits: List[CommitInfo]) -> str:
        ...
        category_order = [
            ...
            'Documentation', 'Testing', 'Infrastructure', 'Dependencies', 'Maintenance'
        ]
