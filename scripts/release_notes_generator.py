...
class ReleaseNotesGenerator:
    ...
    def extract_version_changelog(self, version: str) -> Optional[dict[str, Any]]:
        ...
        return {"version": version, "date": date, "sections": sections, "raw_content": changelog_content}
    ...
    def _generate_default_release_notes(self, version_info: dict[str, Any]) -> str:
        ...
        lines = [f"# Release {version}", "", f"**Release Date:** {date}", "", "## What's New", ""]
...
def main() -> None:
    ...
    parser.add_argument(
        "--template",
        choices=["default", "github", "detailed"],
        default="default",
        help="Template format for release notes",
    )
    ...
    version: str
    if args.latest:
        latest_version = generator.get_latest_version()
